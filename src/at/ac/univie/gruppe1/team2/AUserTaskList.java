 ...
 */
public class AUserTaskList extends ListActivity implements View.OnClickListener {
    ...
    private class GetTaskList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(AUserTaskList.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(AUserTaskList.this, tasklist,
